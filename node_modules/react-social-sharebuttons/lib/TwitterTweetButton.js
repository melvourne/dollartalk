...
var TwitterTweetButton = function (_React$Component) {
  _inherits(TwitterTweetButton, _React$Component);

  function TwitterTweetButton(props) {
    _classCallCheck(this, TwitterTweetButton);

    var _this = _possibleConstructorReturn(this, (TwitterTweetButton.__proto__ || Object.getPrototypeOf(TwitterTweetButton)).call(this, props));

    _this.state = { initialized: false };
    return _this;
  }

  _createClass(TwitterTweetButton, [{
...
exports.default = TwitterTweetButton;


TwitterTweetButton.propTypes = {
  url: _react2.default.PropTypes.string,
  text: _react2.default.PropTypes.string,
  hashtags: _react2.default.PropTypes.string,
